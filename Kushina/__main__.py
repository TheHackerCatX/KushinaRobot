...
from Kushina.Handlers.validation import is_user_admin
...
from Kushina.Plugins import ALL_MODULES
from Kushina.__help__ import (
get_help, 
help_button, 
get_settings, 
settings_button, 
...
A telegram group management bot. I'm here to help you to manage your groups[🤖](https://telegra.ph/file/16de613b49d396f19dd99.jpg).
...
def start(update: Update, context: CallbackContext):
    ...
    [
        ...
        InlineKeyboardButton(
            text="Bot Info", callback_data="kushina_"
        ),
    ],
    [
...
def kushina_about_callback(update: Update, context: CallbackContext):
    first_name = update.effective_user.first_name
    query = update.callback_query
    if query.data == "kushina_":
        query.message.edit_text(
            ...
            \n\n ★ 𝙼𝚈 𝙽𝙰𝙼𝙴: KushinaRobot
            \n ★ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: Ryoishin
            \n ★ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: Telethon
            \n ★ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: Python 3
            \n ★ 𝙳𝙰𝚃𝙰𝙱𝙰𝚂𝙴: Mongodb
            \n ★ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: Linux
            \n ★ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v0.1.2 [ Beta ]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                   [
                     InlineKeyboardButton(text="Support", url="t.me/KushinaSupport"),
                     InlineKeyboardButton(text="News", url="t.me/KushinaNews"),
                   ],
                   [
                    InlineKeyboardButton(text="Back", callback_data="kushina_back")
                   ]
                ]
            ),
        )
    elif query.data == "kushina_back":
        query.message.edit_text(
                PM_START_TEXT.format(
                        escape_markdown(first_name), escape_markdown(context.bot.first_name)),
                reply_markup=InlineKeyboardMarkup([
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(kushina_about_callback, pattern=r"kushina_", run_async=True)
