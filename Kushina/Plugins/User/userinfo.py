...
from Kushina.__help__ import STATS, USER_INFO
import Kushina.Database.userinfo_sql as sql
from Kushina.Plugins.disable import DisableAbleCommandHandler
from Kushina.Database.global_bans_sql import is_user_gbanned
from Kushina.Database.afk_sql import is_afk, check_afk_status
from Kushina.Database.users_sql import get_user_num_chats
from Kushina.Handlers.validation import sudo_plus, user_admin, support_plus
from Kushina.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'Kushina Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/KushinaNews">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/KushinaNews)
"""
__mod_name__ = "Infos"
