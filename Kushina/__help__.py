import importlib, re
from Kushina import dispatcher, ALLOW_EXCL, LOGGER
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from Kushina.Handlers.misc import paginate_modules
